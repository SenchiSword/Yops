...
document.addEventListener('DOMContentLoaded', function() {
    ...
    initUI(storage);
    initActs(storage);  // <-- AJOUT DE L'INITIALISATION DES ACTES
    
    // Variables globales - DÉCLAREZ ICI SEULEMENT
    window.currentDayViewDate = new Date(); // Variable globale pour le calendrier
    ...
    // Calcul de l'âge AVEC VÉRIFICATION
    ...
    // Attacher les événements de navigation AVEC VÉRIFICATION NULL
